package com.myz.starters.sample.table.route.autoconfigure;

import com.myz.starters.sample.table.route.autoconfigure.postprocessor.MybatisConfigurationBeanPostProcessor;
